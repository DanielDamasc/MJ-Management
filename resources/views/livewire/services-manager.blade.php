                ...
                <div class="relative flex flex-col max-h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-primary-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <div class="flex justify-center gap-3">
                            ...
                            @else
                                <button wire:click="serviceCancel" type="button" class="text-white bg-rose-600 dark:bg-rose-700 hover:bg-rose-700 dark:hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-rose-200 dark:focus:ring-rose-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all shadow-md hover:shadow-lg">
                                    Cancelar Serviço
                                </button>
                            @endif
                        </div>
