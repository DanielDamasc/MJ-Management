<div>
    <div class="mb-12">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div>
                <button wire:click="openCreatePlan" class="inline-flex items-center justify-center px-4 py-2
    ...
    <div class="mb-12">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div>
                <button wire:click="openCreateTask" class="inline-flex items-center justify-center px-4 py-2
                border border-transparent text-sm font-medium rounded-lg shadow-sm
                text-white bg-secondary-500 hover:bg-secondary-600
                focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary-500 transition-all
                dark:bg-secondary-600 dark:hover:bg-secondary-500 dark:focus:ring-offset-gray-900 dark:focus:ring-secondary-400">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-primary-950/75 backdrop-blur-sm p-4 md:inset-0 h-modal md:h-full transition-opacity">
            ...
            <div class="relative w-full max-w-2xl h-auto">
                ...
                <div class="relative flex flex-col max-h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-primary-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <form wire:submit="{{ $showTaskCreate ? 'saveTask' : 'editTask' }}" class="flex-1 overflow-y-auto">
                        <div class="p-6 space-y-6">

                            <div>
                                <label class="block mb-1 text-sm font-medium text-primary-700 dark:text-gray-300">Nome da Tarefa
                        ...
                        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-b-xl">
                            ...
                            <button wire:click="{{ $showTaskCreate ? 'saveTask' : 'editTask' }}" type="button" class="text-white bg-secondary-500 hover:bg-secondary-600 dark:bg-secondary-600 dark:hover:bg-secondary-500 focus:ring-4 focus:outline-none focus:ring-secondary-200 dark:focus:ring-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all shadow-md hover:shadow-lg disabled:opacity-50" wire:loading.attr="disabled">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-primary-950/75 backdrop-blur-sm p-4 md:inset-0 h-modal md:h-full transition-opacity">
            ...
            <div class="relative w-full max-w-5xl h-auto">
                ...
                <div class="relative flex flex-col max-h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-primary-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <form wire:submit="{{ $showPlanCreate ? 'savePlan' : 'editPlan' }}" class="flex-1 overflow-y-auto">

                        <div class="p-6 space-y-6">

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="col-span-1 md:col-span-2">
                                    <label class="block mb-1 text-sm font-medium text-primary-700 dark:text-gray-300">Nome do Plano
                                        <span class="text-red-500">*</span>
                                    </label>
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    <label class="block mb-1 text-sm font-medium text-primary-700 dark:text-gray-300">Descrição (Opcional)</label>
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    <div class="flex items-start bg-primary-50/50 dark:bg-gray-900/50 border border-primary-100 dark:border-gray-700 p-4 rounded-lg transition-colors hover:bg-primary-50 dark:hover:bg-gray-900">
                                        <div class="flex items-center h-5 mt-0.5">
                                            <input id="padrao" type="checkbox" wire:model="planForm.padrao"
                                                class="w-4 h-4 text-secondary-600 dark:text-secondary-500 bg-white dark:bg-gray-800 border-primary-300 dark:border-gray-600 rounded focus:ring-secondary-500 focus:ring-2 dark:focus:ring-offset-gray-900 cursor-pointer">
                                        </div>
                                        <div class="ml-3">
                                            <label for="padrao" class="text-sm font-semibold text-primary-900 dark:text-gray-200 cursor-pointer">
                                                Definir como Plano Padrão
                                            </label>
                                            <p class="text-sm text-primary-600 dark:text-gray-400 mt-1">
                            ...
                            <div class="pt-4 border-t border-primary-100 dark:border-gray-700">
                                <div class="mb-3 flex justify-between items-end">
                                    <div>
                                        <h4 class="text-md font-semibold text-primary-900 dark:text-white">Vincular Tarefas</h4>
                                        <p class="text-sm text-primary-500 dark:text-gray-400">Selecione as tarefas que farão parte deste plano de manutenção.</p>
                                    </div>
                                </div>

                                <div class="overflow-hidden border border-primary-200 dark:border-gray-700 rounded-lg shadow-sm">
                                    <div class="max-h-60 overflow-y-auto">
                                        <table class="w-full text-sm text-left text-primary-700 dark:text-gray-300">
                                            <thead class="text-xs text-primary-700 dark:text-gray-300 uppercase bg-primary-100 dark:bg-gray-800 sticky top-0 z-10">
                                                <tr>
                                                    <th scope="col" class="p-4 w-4">
                                                        <x-heroicon-o-check-circle class="w-4 h-4 text-primary-500 dark:text-gray-400" />
                                                    </th>
                                            ...
                                            <tbody>
                                                @forelse($tasks as $task)
                                                    <tr class="bg-white dark:bg-gray-900 border-b border-primary-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                                        ...
                                                        <td class="px-6 py-4 font-medium text-primary-900 dark:text-gray-200">
                                                        ...
                                                        <td class="px-6 py-4">
                                                            <select wire:model="planForm.tarefasSelecionadas.{{ $task->id }}.periodicidade"
                                                                    class="bg-primary-50 dark:bg-gray-800 border border-primary-200 dark:border-gray-600 text-primary-900 dark:text-white text-sm rounded-lg focus:ring-secondary-500 focus:border-secondary-500 block w-full p-2">
                                                ...
                                                @empty
                                                    <tr>
                                                        <td colspan="4" class="px-6 py-8 text-center text-primary-500 dark:text-gray-400">
                        ...
                        <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-b-xl">
                            ...
                            <button wire:click="{{ $showPlanCreate ? 'savePlan' : 'editPlan' }}" type="button" class="text-white bg-secondary-500 hover:bg-secondary-600 dark:bg-secondary-600 dark:hover:bg-secondary-500 focus:ring-4 focus:outline-none focus:ring-secondary-200 dark:focus:ring-gray-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-all shadow-md hover:shadow-lg disabled:opacity-50" wire:loading.attr="disabled">
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-primary-950/75 backdrop-blur-sm p-4 md:inset-0 h-modal md:h-full transition-opacity">
            ...
            <div class="relative w-full max-w-4xl h-auto">
                ...
                <div class="relative flex flex-col max-h-[90vh] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-primary-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="flex-shrink-0 flex items-center justify-between p-5 border-b border-primary-50 dark:border-gray-700 rounded-t bg-primary-50/50 dark:bg-gray-800 z-10">
                        <div>
                            <h3 class="text-xl font-bold text-primary-900 dark:text-white">
                                Tarefas do Plano
                            </h3>
                            <p class="text-sm text-primary-600 dark:text-gray-400 font-medium mt-1">
                                {{ $planLabel }}
                            </p>
                        </div>
                    ...
                    <div class="p-6 flex-1 overflow-y-auto">
                        <div class="overflow-hidden border border-primary-200 dark:border-gray-700 rounded-lg shadow-sm">
                            <div class="w-full overflow-x-auto">
                                <table class="w-full text-sm text-left text-primary-700 dark:text-gray-300">
                                    <thead class="text-xs text-primary-700 dark:text-gray-300 uppercase bg-primary-100 dark:bg-gray-900/50 sticky top-0 z-10 shadow-sm">
                                        <tr>
                                    ...
                                    <tbody class="divide-y divide-primary-50 dark:divide-gray-700/50">
                                        @forelse($planTasks as $planTask)
                                            <tr class="bg-white dark:bg-gray-800 hover:bg-primary-50/50 dark:hover:bg-gray-700/50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 text-center">
                                                    <span class="bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-semibold px-2.5 py-1 rounded-full border border-blue-200 dark:border-blue-800/50">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3" class="px-6 py-8 text-center text-primary-500 dark:text-gray-400">
                    ...
                    <div class="flex-shrink-0 flex items-center justify-end p-5 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-b-xl z-10">
                        <button wire:click="closeModal" type="button" class="text-primary-600 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-primary-50 dark:hover:bg-gray-700 dark:hover:text-white focus:ring-4 focus:outline-none focus:ring-primary-100 dark:focus:ring-gray-700 rounded-lg border border-primary-200 dark:border-gray-600 text-sm font-medium px-5 py-2.5 hover:text-primary-900 focus:z-10 transition-colors">
                            Fechar
                        </button>
                    </div>
