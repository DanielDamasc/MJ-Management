<div class="w-full">
    ...
    <p class="text-xl text-primary-600 dark:text-primary-400 mb-2 font-semibold">
        Dados Gerais
    </p>
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
        ...
        <a  href="{{ route('colaboradores') }}"
            wire:navigate
            class="block relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-200 dark:text-gray-200">
                        Total de Colaboradores
                    </p>
                    <p class="mt-2 text-3xl font-bold text-gray-900 dark:text-white dark:text-white">
                        {{ $this->totalEmployees }}
                    </p>
                </div>

                <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
        ...
        <a  href="{{ route('servicos') }}"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-700 text-blue-600">
                    {{-- <x-heroicon-o-wrench-screwdriver class="h-6 w-6" /> --}}
        ...
        <a  href="{{ route('servicos') }}"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-700 text-green-600">
                    {{-- <x-heroicon-o-wrench-screwdriver class="h-6 w-6" /> --}}
                    <x-heroicon-s-clipboard-document-check class="w-6 h-6" />
                </div>
            </div>
        ...
        <a  href="{{ route('servicos') }}"
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-700 text-red-600">
                    {{-- <x-heroicon-o-wrench-screwdriver class="h-6 w-6" /> --}}
                    <x-heroicon-s-clipboard-document-check class="w-6 h-6" />
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-10">
        <div class="block relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-200">
                        Receita Total
                ...
                <div class="flex h-12 w-12 items-center justify-center rounded-lg bg-gray-50 dark:bg-gray-700 text-yellow-600">
                    {{-- <x-heroicon-o-wrench-screwdriver class="h-6 w-6" /> --}}
